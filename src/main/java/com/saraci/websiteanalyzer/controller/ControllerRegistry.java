...
public class ControllerRegistry {
    ...
    public ControllerRegistry(AppConfig appConfig, SchedulerService schedulerService) {
        ...
        EmailTemplateRepository emailTemplateRepository = appConfig.getEmailTemplateRepository();

        // Services aus der App-Konfiguration holen
        WebsiteAnalyzerService analyzerService = appConfig.getWebsiteAnalyzerService();
        EmailCampaignService emailCampaignService = appConfig.getEmailCampaignService();
        ...
        controllers.add(new LeadController(leadRepository));
        controllers.add(new EmailTemplateController(emailTemplateRepository));
        controllers.add(new EmailCampaignController(emailCampaignService));
